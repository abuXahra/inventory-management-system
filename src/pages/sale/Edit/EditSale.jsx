...
//                             <DropdownWrapper ref={productDropdownRef} topPosition={'70px'}>
//                                  {/* {
...
//                       >
//                         <p style={{ margin: "40px", textAlign: "center", fontSize: "14px", lineHeight: "25px" }}>
//                           <b style={{textTransform: "capitalize", fontSize:"20px"}}>{prodTitle}</b><br/> cannot be added. Quantity exceeds stock quantity {prodStock}<br/>please add more purchase
//                         </p>
//                       </Overlay>
//                     )}
            ...
            <CustomerInfoWrapper>
              <form action="" onSubmit={(e) => hanldeSumbit(e)}>
                <ItemContainer title={'Customer Info'}>
                  ...
                  <Input value={reference} title={'References'} onChange={(e) => handleChange('references', e)} type={'text'} label={'References'} />
                </ItemContainer>
