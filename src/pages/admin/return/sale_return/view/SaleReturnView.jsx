                            ...
                            <ChargesWrapper>
                              <div>
                                ...
                                <TableStyled pd="0px">
                                          ...
                                          <tbody>
                                                 <tr>
                                                      <TdStyled>{new Date(saleReturnData?.saleDate).toDateString()}</TdStyled>
                                                      <TdStyled>{saleReturnData?.saleAmount}</TdStyled>
                              ...
                              <hr />
                                ...
                                <div>
                                  ...
                                  {saleReturnData?.saleAmount?.toLocaleString('en-NG', { 
