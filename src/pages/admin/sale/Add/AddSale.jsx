...
import { AddSalesContent, AddSalesWrapper, AnyItemContainer, CustomerInfoWrapper, HrStyled, InnerWrapper, InputsContainer, ItemListContent, ItemsWrapper, SelectItemContent, TableStyled, TdStyled, TotalChargesWrapper } from './addSale.style'
...
{/* customer info */}
        <CustomerInfoWrapper>
            <form action="" onSubmit={()=>navigate(`/invoice/${1}`)}>
                <ItemContainer title={'Customer Info'}>
                    <Input type={'date'} label={'Date'} />
                    <SelectInput options={customersName} label={'Customer Name'}/>
                ...
                <ItemContainer title={'Payment Info'}>
                    ...
                    <TextArea label={'Note'}/>
                    {/* Add to sale button */}
                    <ItemButtonWrapper pdn={'5px'} btnAlign={'flex-start'}>
                                <Button
                                    title={'Select Items'}
                                    btnText={'Add Sale'}
                                    btnFontSize={'12px'}
