...
import { AnyItemContaineri, DateWrapper, Logo, LogoDateWrapper, LogoWrapper, ReportHeaderContent, ReportHeaderWrapper, SalesReportContent, SalesReportWrapper, SearchReportWrapper, SearchResultWrapper } from './itemDailySaleReport.style'
...
import { AddressWrapper, ItemsDailySaleContent, ItemsDailySaleReportWrapper } from './itemDailySaleReport.style';
...
export default function ItemsDailyReport() {
  ...
  const [showAllReportButton, setShowAllReportButton] = useState(false)
    ...
    const fetchSale = async () => {
        setIsLoading(true)  
        try {
            const res =await  axios.get(`${process.env.REACT_APP_URL}/api/reports/daily-sale`, {
                                                headers: {
                                                  Authorization: `Bearer ${token}`
                                                }
                                          })
        ...
        <ItemsDailySaleContent>
          ...
          <ReportHeaderWrapper>
           ...
           {  company &&  <AddressWrapper>
            ...
            <ItemsDailyReportTable data={saleData} currencySymbol={company?.currencySymbol}/> 
          </ItemsDailySaleContent>       
    </ItemsDailySaleReportWrapper>
  )
}
